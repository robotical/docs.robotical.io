...
*/
    ...
    ext.demo = function(callback){
      cmd = {"cmd": "hello", "id": 0};
      sendCmd(cmd, undefined);

      cmd = {"cmd": "walk", "id": 6, "numsteps": 2, "steplength": 50, "turn": 0, "movetime": 1700};
      sendCmd(cmd, undefined);

      cmd = {"cmd": "walk", "id": 6, "numsteps": 2, "steplength": 0, "turn": 25, "movetime": 1600};
      sendCmd(cmd, undefined);      

      cmd = {"cmd": "hello", "id": 0};
      sendCmd(cmd, undefined);

      cmd = {"cmd": "lean", "id": 0, "direction": 'left', "amount": 50};
      sendCmd(cmd, undefined);

      cmd = {"cmd": "moveJoint", "id": 12, "joint": 'right knee', "angle": parseInt(-35), "movetime": parseInt(500)};
      sendCmd(cmd, undefined);

      cmd = {"cmd": "moveJoint", "id": 12, "joint": 'right hip', "angle": parseInt(-40), "movetime": parseInt(500)};
      sendCmd(cmd, undefined);
